        ...
        <div className="hero-content flex-col lg:flex-row-reverse max-w-7xl px-4 gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-lg lg:text-xl text-base-content/70 mb-8 max-w-2xl">
              Discover, borrow, and enjoy thousands of books from the comfort of
              your home. Join CityLibrary today and embark on your reading
              adventure.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-base-content/70 max-w-2xl mx-auto">
              Experience the future of library management with features designed
              for modern readers
            </p>
          </div>
          ...
          <div className="card bg-linear-to-r from-primary to-secondary text-primary-content shadow-2xl rounded-3xl">
            <div className="card-body items-center text-center py-12">
              ...
              <div className="card-actions">
                <button className="btn btn-lg bg-base-100 text-primary hover:bg-base-200 border-none gap-2 shadow-lg rounded-full">
